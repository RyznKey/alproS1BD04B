...
a*=10     # mengalikan dengan 10
print(a)  # menampilkan hasil nilai a dikali dengan 10
a/= 4     # membagi dengan 4
print(a)  # menampilkan hasil nilai a dibagi dengan 4
a**= 2    # mempangkatkan dengan 2
